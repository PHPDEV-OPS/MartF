            ...
            <div class="container-xl installer-container">
                <div class="row mb-6">
                    <div class="col">
						...
						<h2 class="h1 page-title justify-content-center text-white">NULLED by raz0r :: <a style="color:red;" href="https://bit.ly/ncave_club" target="_blank">NULLED Forum</a></h2>
                    </div>
                </div>
