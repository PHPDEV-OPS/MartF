...
**MartF** is a multivendor e-commerce platform built in PHP (Laravel). It allows multiple vendors to register, list products, and receive orders, while giving the site owner/admin control over the marketplace.
